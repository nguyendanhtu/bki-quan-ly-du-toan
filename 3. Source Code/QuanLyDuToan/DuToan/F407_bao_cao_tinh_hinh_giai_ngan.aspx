            ...
            <td colspan="4" align="center">
                <asp:GridView ID="m_grv" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nội dung" HeaderStyle-Width="10%">
                            <ItemTemplate>
                                <%# Container.DataItemIndex + 1 %>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Khối lượng thực hiện" HeaderStyle-Width="6%">
                            <ItemTemplate>
                                <%# Container.DataItemIndex + 1 %>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="Khối lượng còn nợ nhà thầu" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="7%">
                            <ItemTemplate>
                                <%# Container.DataItemIndex + 1 %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Ghi chú" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="3%">
                            <ItemTemplate>
                                <%# Container.DataItemIndex + 1 %>
                            </ItemTemplate>
                        </asp:TemplateField>
