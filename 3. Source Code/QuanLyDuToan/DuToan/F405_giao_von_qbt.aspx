	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
										...
										<asp:Panel ID="m_pnl_chi_thuong_xuyen" runat="server" GroupingText="Chi thường xuyên">
											<table cellspacing="0" cellpadding="2" style="width: 99%;" border="0">
												...
												<tr>
													...
													<td>
														<asp:Label ID="m_lbl_ctx_so_tien_kh_giao" runat="server" ForeColor="blue"></asp:Label>
														<asp:HiddenField ID="m_hdf_ctx_so_tien_kh_giao" runat="server" />
													</td>
												</tr>
												<tr>
										...
										<asp:Panel ID="m_pnl_chi_khong_thuong_xuyen" runat="server" GroupingText="Chi không thường xuyên">
											<table cellspacing="0" cellpadding="2" style="width: 99%;" border="0">
												...
												<tr>
													...
													<td>
														<asp:Label ID="m_lbl_cktx_so_tien_KH_giao" runat="server" ForeColor="blue"></asp:Label>
														<asp:HiddenField ID="m_hdf_cktx_so_tien_kh_giao" runat="server" />
													</td>
												</tr>
												<tr>
													<td colspan="2" align="center">
			...
			<table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
				<tr>
					<td class="cssPageTitleBG" colspan="4">
						<asp:Label ID="m_lbl_grid_title" runat="server" Text="Chi tiết giao vốn" CssClass="cssPageTitle"></asp:Label>
					</td>
				</tr>
				<tr>
					<td style="width: 30%" align="right">
