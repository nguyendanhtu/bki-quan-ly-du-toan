			...
			<div style="width: 1300px; height: 700px; border: 1px solid #C9BDAB">
				...
				<div style="width: 1280px; height: 650px; margin: 3px auto;">
					<div style="width: 510px; height: 650px; float: left;">
						...
						<fieldset>
							...
							<div id="group_lkm" style="display: none;">
								...
								<div style="clear: both; height: 20px;" class="lbl">Nội dung dự toán (*)</div>
								<div style="height: 20px;" class="ctr">
									<asp:TextBox ID="m_txt_noi_dung_du_toan" placeholder="Kinh phí thực hiện nhiệm vụ KHCN" runat="server" Width="176px"></asp:TextBox>
								</div>
							...
							<div>
								...
								<div style="clear: both; height: 20px;" class="lbl"><asp:Label ID="m_lbl_kinh_phi" runat=  "server">Kinh phí Quỹ BT</asp:Label></div>
								<div style="height: 20px;" class="ctr">
					...
					<div style="width: 765px; height: 650px; float: left; margin-left: 5px;">
						...
						<br />
						Tổng kinh phí:
						<asp:Label ID="m_lbl_grid_tong_tien" runat="server" Font-Bold="false" CssClass="cssManField"></asp:Label>đ
