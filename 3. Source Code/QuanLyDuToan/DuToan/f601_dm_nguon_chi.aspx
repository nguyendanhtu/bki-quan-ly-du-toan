<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="f601_dm_nguon_chi.aspx.cs" Inherits="DuToan_f601_dm_nguon_chi" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table cellspacing="0" cellpadding="2" style="width: 99%;" class="cssTable" border="0">
                ...
                <tr>
                    <td align="right">
                        <span class="cssManField">Tên đầy đủ</span>
                    </td>
                    <td>
                        <asp:TextBox ID="m_txt_ten_day_du" placeholder="Chi sự nghiệp môi trường" runat="server" CssClass="cssTextBox" Width="80%"></asp:TextBox>
                    </td>
                    <td align="right">
