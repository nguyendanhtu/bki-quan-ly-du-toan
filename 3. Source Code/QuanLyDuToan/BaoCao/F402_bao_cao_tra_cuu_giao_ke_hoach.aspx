<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="F402_bao_cao_tra_cuu_giao_ke_hoach.aspx.cs" Inherits="QuanLyDuToan.BaoCao.F402_bao_cao_tra_cuu_giao_ke_hoach" %>
			...
			<table id="main_table" style="width: 100%;" class="cssTable table " border="0">
				<tr>
					<td colspan="4" style="text-align: center">
						...
						<br />
						<br />
						<span style="font-weight: bold">BÁO CÁO TRA CỨU GIAO KẾ HOẠCH THEO DỰ ÁN <%=DateTime.Now.Year.ToString() %></span>
						<br />
				...
				<tr>
					...
					<td colspan="4" style="text-align: center">
						...
						<asp:Button ID="m_cmd_xuat_excel" Text="Xuất file excel" runat="server" CssClass="cssButton btn" Height="24px" Width="98px" OnClick="m_cmd_xuat_excel_Click" />
					</td>
				</tr>
				<tr>
