<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="F701_tinh_hinh_giai_ngan_von_don_vi.aspx.cs" Inherits="QuanLyDuToan.BaoCao.F701_tinh_hinh_giai_ngan_von_don_vi" %>
					...
					<td colspan="4" align="center">
						<asp:GridView ID="m_grv" runat="server" AutoGenerateColumns="false"
							...
							<Columns>
								...
								<asp:BoundField DataField="TEN_DON_VI" HeaderText="Nội dung" HeaderStyle-Width="20%" />
