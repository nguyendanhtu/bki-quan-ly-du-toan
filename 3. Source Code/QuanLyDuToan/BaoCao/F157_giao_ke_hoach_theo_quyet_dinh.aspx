							...
							<div style="width: 70%; margin: 0px auto">
								<div class="boxControl">
									<div class="height30">
										...
										<div class="control">
											<asp:DropDownList ID="m_ddl_loai_nv" runat="server" Width="100px" AutoPostBack="True" CssClass="select2" OnSelectedIndexChanged="m_ddl_loai_nv_SelectedIndexChanged"></asp:DropDownList>
										</div>
									</div>
									<div class="height30">
										<div class="lb">Công trình</div>
										<div class="control">
											<asp:DropDownList ID="m_ddl_cong_trinh" runat="server" Width="100px" AutoPostBack="True" CssClass="selec2" OnSelectedIndexChanged="m_ddl_cong_trinh_SelectedIndexChanged"></asp:DropDownList>
										</div>
									</div>
									<div class="height30">
										<div class="lb">Dự án</div>
										<div class="control">
											<asp:DropDownList ID="m_ddl_du_an" runat="server" Width="100px" CssClass="selec2"></asp:DropDownList>
										</div>
									</div>
							...
							<asp:GridView ClientIDMode="Static" ID="m_grv" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
								...
								<Columns>
									...
									<asp:TemplateField>
										...
										<ItemTemplate>
											<%#CIPConvert.ToStr( 
		   CIPConvert.ToDecimal(Eval("tong_tien_ntcs")) 
		   +CIPConvert.ToDecimal(Eval("tong_tien")),"#,###,##") %>
										</ItemTemplate>
									</asp:TemplateField>
								</Columns>
