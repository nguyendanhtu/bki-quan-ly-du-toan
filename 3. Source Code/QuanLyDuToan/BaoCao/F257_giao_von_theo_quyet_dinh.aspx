								...
								<div class="boxControl">
									...
									<div class="height30" style="margin-bottom: 5px;">
										...
										<div id="datetimepicker2" class="input-group date datepicker" style="width: 200px;">
											<asp:TextBox ClientIDMode="Static" ID="m_txt_den_ngay" AutoPostBack="true" placeholder="dd/MM/yyyy" runat="server" CssClass="cssTextBox date-end" Height="30px" Width="164px" OnTextChanged="m_txt_den_ngay_TextChanged"></asp:TextBox>
											<span class="input-group-addon"><span class="glyphicon-calendar glyphicon"></span>
											</span>
										</div>
									</div>
