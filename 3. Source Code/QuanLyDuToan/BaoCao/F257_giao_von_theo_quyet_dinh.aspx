<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="F257_giao_von_theo_quyet_dinh.aspx.cs" Inherits="QuanLyDuToan.BaoCao.F257_giao_von_theo_quyet_dinh" %>
	...
	<script>
		function pageLoad(sender, args) {
			if (args.get_isPartialLoad()) {
				...
				getData("TPL_F257", "m_grv", "Bao_cao_tinh_hinh_giao_von_quy_bao_tri", m);
                ...
                if ($("#<%=m_ddl_quyet_dinh.ClientID%>").val().toString() == "-1") {
            		$("#m_anchor_so_quyet_dinh").attr("href", "../DanhMuc/F290_danh_sach_quyet_dinh_giao_von.aspx?ip_dat_tu_ngay=" + $("#<%=m_txt_tu_ngay.ClientID%>").val() + "&ip_dat_den_ngay=" + $("#<%=m_txt_den_ngay.ClientID%>").val() + "&ip_dc_id_don_vi=" + $('#m_ddl_don_vi').val());
                }
                else {
                	$("#m_anchor_so_quyet_dinh").attr("href", "../DuToan/F204_nhap_giao_von_QBT.aspx?ip_dc_id_quyet_dinh=" + $("#<%=m_ddl_quyet_dinh.ClientID%>").val() + "&ip_dc_id_don_vi=" + $("#<%=m_ddl_don_vi.ClientID%>").val());
                }
					...
					<tr>
						<td colspan="4" style="text-align: center">
							<p>
								...
								<br />
								<asp:DropDownList ID="m_ddl_don_vi" runat="server" Width="180px" AutoPostBack="True" CssClass="select2" ClientIDMode="Static"></asp:DropDownList>
							</p>
								...
								<div class="boxControl">
									...
									<div class="height30" style="margin-bottom: 5px;">
										...
										<div id="datetimepicker2" class="input-group date datepicker" style="width: 200px;">
											<asp:TextBox ClientIDMode="Static" ID="m_txt_den_ngay" AutoPostBack="true" placeholder="dd/MM/yyyy" runat="server" CssClass="cssTextBox form-control date-end" Height="30px" Width="164px" OnTextChanged="m_txt_den_ngay_TextChanged"></asp:TextBox>
											<span class="input-group-addon"><span class="glyphicon-calendar glyphicon"></span>
											</span>
										</div>
									</div>
				...
				<tbody>
					<tr>
						...
						<td colspan="4" style="text-align: center">
							...
							<asp:Button CssClass="btn btn-sm btn-primary" Visible="false" ID="m_cmd_xuat_excel" Text="Xuất file excel" runat="server" OnClick="m_cmd_xuat_excel_Click" />
						</td>
					</tr>
					<tr>
						<td colspan="4">
