                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(7)" HeaderStyle-Height="10px">
                                        <ItemTemplate>
                                          <%--  <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr( format_so_tien( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG)) , "#,###")
											%></font>--%>
                                            <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%#CCommonFunction.getMoney_string_format(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG)))
											%></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(8) = (5) + (7)" HeaderStyle-Height="10px">
                                        <ItemTemplate>
                                           <%-- <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr( format_so_tien( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_TONG) )
                                             ...
                                             <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CCommonFunction.getMoney_string_format(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_TONG))
                                                + CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG))) %></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <a class='a<%# Eval(GRID_GIAI_NGAN.ID)%>' href="<%#FormInfo.FormName.F357.ToString()%><%# format_link_to_chi_tiet(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.REPORT_LEVEL)
                                               ...
                                               <%-- title="Xem chi tiết"><%# CIPConvert.ToStr( format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TONG)) , "#,###") %>--%>
                                                  title="Xem chi tiết"><%#  CCommonFunction.getMoney_string_format( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TONG)) %>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(13) = (10) + (12)" HeaderStyle-Height="10px">
                                        <ItemTemplate>
                                           <%-- <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr( (format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_TONG)) 
                                            ...
                                            , "#,###") %></font>--%>
                                             <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CCommonFunction.getMoney_string_format( CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_TONG)) 
                                            + CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TONG))) %></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                           <%-- <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr( (format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_TONG)) 
                                            ...
                                            + format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TONG)))  , "#,###") %></font>--%>
                                             <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CCommonFunction.getMoney_string_format(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_TONG)) 
                                            + CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG))  
                                            - CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_TONG)) 
                                            + CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TONG))) %></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(15) = (1) + (c) - (5)" HeaderStyle-Height="10px">
                                        <ItemTemplate>
                                            ...
                                            <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CCommonFunction.getMoney_string_format(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_QBT)) + CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_NAM_TRUOC_CHUYEN_SANG))  
                                                        - CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_TONG)))%></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(16) = (2) - (7)" HeaderStyle-Height="10px">
                                        <ItemTemplate>
                                          <%--  <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr( format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_NS)) 
                                                        - format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG)), "#,###") %></font>--%>
                                              <font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CCommonFunction.getMoney_string_format(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_NS)) 
                                                        - CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_TONG))) %></font>
                                        </ItemTemplate>
                                        <HeaderStyle Height="10px" HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Right" Width="120px" />
