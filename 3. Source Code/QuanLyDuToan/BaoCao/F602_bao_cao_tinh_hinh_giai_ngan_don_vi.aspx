			...
			<table id="main_table" style="width: 150%;" class="cssTable table" border="0">
				...
				<tr>
					...
					<td colspan="4" style="text-align: center">
						...
						<asp:Button ID="m_cmd_xuat_excel" Text="Xuất excel" runat="server" CssClass="cssButton" Height="24px" Width="98px" OnClick="m_cmd_xuat_excel_Click" />
					</td>
				</tr>
				<tr>
							...
							<Columns>
									...
									<ItemTemplate>
										<table cellspacing="0" cellpadding="2" style="width: 100%;" border="0">
											<tr>
												...
												<td style="width: 40%; height: 40px;" align="right"><%#format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_TONG).ToString()) %></td>
											</tr>
										</table>
									</ItemTemplate>
								</asp:TemplateField>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right">
									...
									<ItemTemplate>
										<table style="width: 100%;" border="0">
											<tr>
												<td style="width: 25%; height: 40px; border-right: 1px solid #b0b0d9; text-align: right" class="cssGridCellTable"><%#format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_TRONG_THANG).ToString()) %></td>
												<td style="width: 25%; height: 100%; border-right: 1px solid #b0b0d9; text-align: right" class="cssGridCellTable"><%#format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_LUY_KE).ToString()) %></td>
												<td style="width: 25%; height: 100%; border-right: 1px solid #b0b0d9; text-align: right" class="cssGridCellTable"><%#format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TRONG_THANG).ToString()) %></td>
												<td style="width: 25%; height: 100%; text-align: right" class="cssGridCellTable"><%#format_so_tien(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_LUY_KE).ToString()) %></td>
											</tr>
										</table>
									</ItemTemplate>
								</asp:TemplateField>
