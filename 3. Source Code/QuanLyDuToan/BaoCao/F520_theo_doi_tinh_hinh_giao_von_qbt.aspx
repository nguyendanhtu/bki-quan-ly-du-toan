		...
		<ContentTemplate>
		    ...
		    <br />--%>
				...
				<div style="width: 220px; text-align: center; margin: auto; height: 45px;">
					...
					<asp:Button Visible="false" ID="m_cmd_xuat_excel" Text="Xuất file excel" runat="server" CssClass="btn btn-sm btn-primary" Enabled="true" OnClick="m_cmd_xuat_excel_Click" />
				</div>
