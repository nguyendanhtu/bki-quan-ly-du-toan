	...
	<script>
		function pageLoad(sender, args) {
			if (args.get_isPartialLoad()) {
				...
				//var tableOffset = $("#m_grv").offset().top;
				//var $header = $("#m_grv > tbody >").clone();
				...
				<div class="outer">
					<div style="width: 1800px; margin: 20px auto" class="inner">
						...
						<asp:GridView ID="m_grv" runat="server" AutoGenerateColumns="False" ClientIDMode="Static"
							...
							<Columns>
								<asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="(a)" HeaderStyle-Height="10px" HeaderStyle-CssClass="pinned thpinned" ItemStyle-CssClass=" pinned">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="(b)" HeaderStyle-Height="10px" HeaderStyle-CssClass="pinned thpinned" ItemStyle-CssClass=" pinned">
									<ItemTemplate>
