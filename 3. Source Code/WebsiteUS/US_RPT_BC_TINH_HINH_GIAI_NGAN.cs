...
namespace WebUS
{
	...
	public class US_RPT_BC_TINH_HINH_GIAI_NGAN : US_Object
	{
        ...
        public string strREPORT_LEVED
        {
            get
            {
                return CNull.RowNVLString(pm_objDR, "REPORT_LEVED", IPConstants.c_DefaultString);
            }
            set
            {
                pm_objDR["REPORT_LEVED"] = value;
            }
        }

        public bool IsREPORT_LEVEDNull()
        {
            return pm_objDR.IsNull("REPORT_LEVED");
        }

        public void SetREPORT_LEVEDNull()
        {
            pm_objDR["REPORT_LEVED"] = System.Convert.DBNull;
        }
