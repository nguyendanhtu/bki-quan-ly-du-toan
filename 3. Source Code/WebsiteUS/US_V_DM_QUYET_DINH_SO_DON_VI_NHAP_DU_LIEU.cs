///************************************************
/// Generated by: TuDM
/// Date: 18/01/2015 05:12:25
/// Goal: Create User Service Class for V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU
///************************************************
/// <summary>
/// Create User Service Class for V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU
/// </summary>
...
namespace WebUS
{
	...
	public class US_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU : US_Object
	{
		private const string c_TableName = "V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU";
		...
		public decimal dcSO_DON_VI
		{
			get
			{
				return CNull.RowNVLDecimal(pm_objDR, "SO_DON_VI", IPConstants.c_DefaultDecimal);
			}
			set
			{
				pm_objDR["SO_DON_VI"] = value;
			}
		}

		public bool IsSO_DON_VINull()
		{
			return pm_objDR.IsNull("SO_DON_VI");
		}

		public void SetSO_DON_VINull()
		{
			pm_objDR["SO_DON_VI"] = System.Convert.DBNull;
		}

		#endregion
		#region "Init Functions"
		public US_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU()
		{
			pm_objDS = new DS_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU();
			pm_strTableName = c_TableName;
			pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
		}

		public US_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU(DataRow i_objDR)
			: this()
		{
			this.DataRow2Me(i_objDR);
		}

		public US_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU(decimal i_dbID)
		{
			pm_objDS = new DS_V_DM_QUYET_DINH_SO_DON_VI_NHAP_DU_LIEU();
			pm_strTableName = c_TableName;
