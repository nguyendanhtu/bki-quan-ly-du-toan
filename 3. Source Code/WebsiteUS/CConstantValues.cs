...
namespace WebUS
{
	...
	public class STR_NGUON
	{
		public const string NGAN_SACH = "Y";
		public const string QUY_BAO_TRI = "N";
	}
	...
	public class CONST_GIAO_DICH
	{
		...
		public const string STR_VALUE_TAT_CA = "-1";
		public const string TEXT_TAT_CA = "---------Tất cả---------";
