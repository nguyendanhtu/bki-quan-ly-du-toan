    ...
    <table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
        ...
        <tr>
            ...
            <td colspan="2" align="left">
                ...
                <asp:Button ID="btnCancel" AccessKey="r" CssClass="btn" runat="server" Text="Xóa trắng(r)" OnClick="btnCancel_Click" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="m_cmd_tim_kiem" AccessKey="c" CssClass="btn" runat="server" Width="98px"
