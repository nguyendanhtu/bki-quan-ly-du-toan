<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="F810_PhanQuyenUserGroup.aspx.cs" Inherits="QuanLyDuToan.Quantri.F810_PhanQuyenUserGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	<table cellspacing="0" cellpadding="2" style="width: 100%;" class="cssTable" border="0">
		...
		<tr>
			...
			<td>
				<asp:DropDownList ClientIDMode="Static" ID="m_cbo_user_group" runat="server" Width="300px" CssClass="cssDorpdownlist"
		...
		<tr>
			...
			<td colspan="2">
				<asp:ListBox ID="m_lst_chuc_nang" CssClass="form-control" runat="server" Width="100%" Height="300px" SelectionMode="Multiple"></asp:ListBox>
			</td>
			...
			<td colspan="2">
				<asp:ListBox ID="m_lst_chuc_nang_user"  CssClass="form-control"  runat="server" Width="100%" Height="300px"
