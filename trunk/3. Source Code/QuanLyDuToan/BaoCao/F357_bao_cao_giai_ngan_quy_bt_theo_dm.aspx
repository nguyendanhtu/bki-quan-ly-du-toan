<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="F357_bao_cao_giai_ngan_quy_bt_theo_dm.aspx.cs" Inherits="QuanLyDuToan.BaoCao.F357_bao_cao_giai_ngan" %>
        ...
        function pageLoad(sender, args) {
            if (args.get_isPartialLoad()) {
                ...
                if ($("#<%=m_ddl_quyet_dinh.ClientID%>").val().toString() == "-1") {
                    $("#m_anchor_so_quyet_dinh").attr("href", "../DanhMuc/F390_Danh_sach_uy_nhiem_chi.aspx?ip_dat_tu_ngay=" + $("#<%=m_txt_tu_ngay.ClientID%>").val() + "&ip_dat_den_ngay=" + $("#<%=m_txt_den_ngay.ClientID%>").val());
                }
                else {
                    $("#m_anchor_so_quyet_dinh").attr("href", "../DuToan/f206_nhap_uy_nhiem_chi_qbt.aspx?ip_nguon_ns=N&ip_dc_id_dm_giai_ngan=" + $("#<%=m_ddl_quyet_dinh.ClientID%>").val() + "&ip_dc_id_don_vi=" + $("#<%=m_ddl_don_vi.ClientID%>").val());
                }
			...
			<table id="main_table" style="width: 1000px; margin: auto;" class="cssTable table">
                ...
                <tr>
					<td colspan="4" style="text-align: center">
						<p>
							<span style="font-weight: bold">BÁO CÁO TÌNH HÌNH GIẢI NGÂN THEO UỶ NHIỆM CHI <%=DateTime.Now.Year.ToString() %></span>
							<br />
                        ...
                        <div style="width:70%; margin:0px auto">
                            ...
                            <div class="boxControl">
                                ...
                                <div class="height30">
							        <div class="lb" style="margin-right:34px">Uỷ nhiệm chi</div>
