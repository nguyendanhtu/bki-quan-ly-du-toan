				...
				<div class="outer">
					<div style="width: 1200px; margin: auto;" id="double-scroll">
						<asp:GridView ID="m_grv" runat="server" AutoGenerateColumns="False" ClientIDMode="Static"
							Width="2600px" CellPadding="0" ForeColor="Black" AllowSorting="True" PageSize="60"
							EmptyDataText="Không có dữ liệu phù hợp" OnRowCreated="m_grv_RowCreated" EnableModelValidation="True">

							<Columns>
								<asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="(a)" HeaderStyle-Height="10px" HeaderStyle-CssClass="pinned thpinned" ItemStyle-CssClass=" pinned" ItemStyle-Width="25px" HeaderStyle-Width="25px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="(b)" HeaderStyle-Height="10px" HeaderStyle-CssClass="pinned thpinned" ItemStyle-CssClass=" pinned" ItemStyle-Width="222px" HeaderStyle-Width="222px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="(0)" HeaderStyle-Height="10px" ItemStyle-Width="55px" HeaderStyle-Width="55px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(1)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(2)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(3)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(4) = (1) + (2) +(3)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(6)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'>
											<%# 
														CIPConvert.ToStr(
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(9) = (6) + (8)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'>
											<%# 
														CIPConvert.ToStr(
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(10)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(14) = (11) + (13)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'>
											<%# 
														CIPConvert.ToStr(
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(15) = (6+8) - (11+13)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'>
											<%#CIPConvert.ToStr(
														CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_QBT_LUY_KE))
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(16) = (1) + (3) - (6)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(17) = (2) - (8)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'><%# CIPConvert.ToStr(  
													   CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.KH_NS)) 
                                                -		(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DN_NS_LUY_KE))
								...
								<asp:TemplateField ItemStyle-HorizontalAlign="Right" HeaderText="(19)=(18)-(14)" HeaderStyle-Height="10px" HeaderStyle-Width="120px">
									<ItemTemplate>
										<font class='a<%# Eval(GRID_GIAI_NGAN.ID)%>'>
											<%# CIPConvert.ToStr(  
													   CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.GIA_TRI_THUC_HIEN))
													  -(CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_LUY_KE))
                                                +		CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_QBT_TRONG_THANG))
												+		CCommonFunction.getMoney_number(Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_LUY_KE))
                                                +		CCommonFunction.getMoney_number( Eval(RPT_BC_TINH_HINH_GIAI_NGAN.DTT_NS_TRONG_THANG))) 
