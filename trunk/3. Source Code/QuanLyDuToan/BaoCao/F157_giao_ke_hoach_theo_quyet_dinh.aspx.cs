...
namespace QuanLyDuToan.BaoCao
{
    public partial class F157_giao_ke_hoach_theo_quyet_dinh : System.Web.UI.Page
    {
        ...
        private void set_inital_form_load()
        {
            ...
            v_dc_id_cong_trinh = CIPConvert.ToDecimal(WebformFunctions.getValue_from_query_string(
                this
                , FormInfo.QueryString.ID_CONG_TRINH
                , -1
                , DataType.NumberType));

            v_dc_id_du_an = CIPConvert.ToDecimal(WebformFunctions.getValue_from_query_string(
                this
            ...
            m_ddl_don_vi.SelectedValue = CIPConvert.ToStr(WebformFunctions.getValue_from_query_string(
                this
        ...
        private void load_data_to_grid()
        {
            ...
            v_ip_str_nguon_ngan_sach = CIPConvert.ToStr(WebformFunctions.getValue_from_query_string(
                this
                , FormInfo.QueryString.NGUON_NGAN_SACH
                , "N"
                , DataType.StringType));
            if (v_ip_str_nguon_ngan_sach == STR_NGUON_NGAN_SACH.CO_NGUON_NGAN_SACH)
            {
                field.HeaderText = "Kinh phí Ngân sách";
                v_str_nguon_ngan_sach = STR_NGUON_NGAN_SACH.CO_NGUON_NGAN_SACH;
            }
            else
            {
                field.HeaderText = "Kinh phí Quỹ bảo trì";
                v_str_nguon_ngan_sach = "N";
            }
        ...
        private void load_data_2_ddl_don_vi()
        {
            ...
            WinFormControls.load_data_to_ddl_don_vi_get_list_don_vi_duoc_xem_du_lieu(
                 CIPConvert.ToDecimal(WebformFunctions.getValue_from_query_string(
                   this
                       , FormInfo.QueryString.ID_DON_VI
                       , Person.get_id_don_vi()
                       , DataType.NumberType))// id don vi
                , m_ddl_don_vi);
        }
        #endregion
