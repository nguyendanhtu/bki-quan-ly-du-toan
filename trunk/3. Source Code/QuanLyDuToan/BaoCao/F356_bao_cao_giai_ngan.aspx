        ...
        <div style="width:800px; margin:20px auto;">
            <asp:gridview runat="server" id="m_grv_bao_cao_giai_ngan" style="width:100%;" AutoGenerateColumns="False" EnableModelValidation="True">
                <Columns>
                    ...
                    <asp:BoundField DataField="SO_TIEN_NS" HeaderText="Kinh phí thanh toán&lt;br /&gt;ngân sách &lt;br /&gt; (5)" HtmlEncode="False">
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    <asp:BoundField DataField="TONG" HeaderText="&lt;br /&gt;Tổng &lt;br /&gt; (6) = (4) + (5)" HtmlEncode="False">
                    <ItemStyle HorizontalAlign="Right" Width="120px" />
                    <ItemStyle HorizontalAlign="Right" Width="120px" />
                    <ItemStyle HorizontalAlign="Right" Width="120px" />
                    </asp:BoundField>
