...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			<div style="text-align: center; margin-bottom: -33px">
                ...
                <asp:DropDownList ID="m_ddl_don_vi" CssClass="select2" runat="server" AutoPostBack="true"
					OnSelectedIndexChanged="m_ddl_don_vi_SelectedIndexChanged" Width="200px">
				</asp:DropDownList>
			</div>
		...
		<%--<span>Từ khóa tìm kiếm: </span>
            ...
            <div style="text-align: center">
                <asp:Button CssClass="btn btn-primary btn-sm" runat="server" Text="Xuất file excel" ID="m_cmd_xuat_excel"
