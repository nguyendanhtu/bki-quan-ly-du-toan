				...
				<tr>
					<td>
							...
							<table cellspacing="0" cellpadding="2" style="width: 99%;" border="0">
								...
								<tr>
									<td colspan="4" align="center">
										<asp:GridView ID="m_grv" runat="server" AllowPaging="True" AutoGenerateColumns="true"
											DataKeyNames="ID"
                     ...
                     <img alt="Xóa" src="../Images/Button/edit.png" />
												...
												<%--<asp:BoundField DataField="<%#v_gd %>" HeaderText="Công trình, dự án" />--%>
												...
												<asp:TemplateField HeaderText="Số tiền" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="100px">
													<ItemTemplate>
														<asp:Label ID="m_lbl_so_tien_ngan_sach_grid" runat="server"
															CssClass="cssManField" ForeColor="Blue"
															Text='<%#format_so_tien(Eval(V_GD_GIAO_KH_QBT.SO_TIEN_NS).ToString()) %>'></asp:Label>
													</ItemTemplate>
												</asp:TemplateField>
