						...
						<asp:Panel ID="m_pnl_thong_tin_ve_qd_giao_ke_hoach" GroupingText="Thông tin chung" runat="server">
							<table style="width: 99%;" border="0">
								...
								<tr>
									...
									<td style="width: 35%"><asp:TextBox ID="m_txt_ngay_thang" runat="server" CssClass="cssTextBox" Width="100px" placeholder="dd/MM/yyyy"></asp:TextBox></td>
								</tr>
								<tr>
				...
				<tr>
					<td>
                     ...
                     <img alt="Xóa" src="../Images/Button/deletered.png" />
								...
								<tr>
									<td colspan="3" style="text-align:center">
										<asp:Button ID="m_cmd_cap_nhat" runat="server" Text="Ghi dữ liệu" />
										<asp:Button ID="m_cmd_xoa_trang" runat="server" Text="Huỷ thao tác" />
									</td>
								</tr>
							</table>
						</asp:Panel>
